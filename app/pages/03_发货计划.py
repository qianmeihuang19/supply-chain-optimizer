...
with tab2:
    ...
    st.dataframe({
        ...
        "服务商": ["顺丰货运", "德邦物流", "顺丰货运"],
        "服务商编号": ["CR001", "CR002", "CR001"],
        "运费": ["¥12,000", "¥10,000", "¥8,000"],
    }, use_container_width=True, hide_index=True)

with tab3:
    st.subheader("装载方案可视化")
    st.info("同一资源编号如有多个货主，每行单独显示")
    st.dataframe({
        "运输方式": ["公路/车辆", "公路/车辆", "公路/车辆", "公路/车辆"],
        "资源编号": ["V0001", "V0001", "V0006", "V0011"],
        "车型":     ["40尺箱式集装箱", "40尺箱式集装箱", "40尺箱式集装箱", "40尺箱式集装箱"],
        "最大托盘": [36, 36, 36, 36],
        "实际装载": [30, 30, 22, 24],
        "装载率":   ["83.3%", "83.3%", "61.1%", "66.7%"],
        "货主(托运人)": ["上海远程贸易有限公司", "上海联合供应链有限公司", "上海远程贸易有限公司", "上海联合供应链有限公司"],
    }, use_container_width=True, hide_index=True)
